...
if normType ~= 1  
    ...
    sac2CondCol = 94;
    rand1 = 2;       % normalization to distractor absent trials
end
...
for tCorTrials = 1:size(partCoord_all,2)
    ...
    rand4               = partCoord_all{tCorTrials}{1}(1,8);
    accurateSac1Trial   = partCoord_all{tCorTrials}{1}(1,89);
    accurateSac2Trial   = partCoord_all{tCorTrials}{1}(1,92);
    sac2Onset           = partCoord_all{tCorTrials}{1}(1,58);
    sac2Offset          = partCoord_all{tCorTrials}{1}(1,59);
    ...
    if accurateSac1Trial && accurateSac2Trial
        ...
        if normType ~= 1
            datSac2RawResize = [datSac2RawResize(:,1) - sac2CondMat{sac2Cond,rand1}{2}(:,1),datSac2RawResize(:,2)];
