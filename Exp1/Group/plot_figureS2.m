function plot_figureS2(sub)
% ----------------------------------------------------------------------
% plot_figureS2(sub)
% ----------------------------------------------------------------------
% Goal of the function :
% Draw Figure S2 as in manuscript
% ----------------------------------------------------------------------
% Input(s) :
...
% load data
load(sprintf('%s/%s_sac2BeforeInterSac1LatT_norm.mat',sub.deriv_filedir,sub.ini));
load(sprintf('%s/%s_sac2BeforeIntraSac1LatT_norm.mat',sub.deriv_filedir,sub.ini));
...
for tRow = 1:numRow
    switch tRow
        case 1;
            ...
            matRes = sac2BeforeInterSac1LatT;
        case 2;
        ...
        case 3;
            fig.xAxisTxt = 'Horizontal coordinates (deg)';
            fig.yAxisTxt = 'Vertical coordinates (deg)';
            matRes = sac2BeforeIntraSac1LatT;
        case 4;
            fig.xAxisTxt = 'Curvature angle (deg)';
            fig.yAxisTxt = '';
            matRes = sac2BeforeIntraSac1LatT;
...
saveas(f,sprintf('%s/FigureS2.pdf',sub.deriv_filedir));      % classical save
