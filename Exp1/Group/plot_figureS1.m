function plot_figureS1(sub)
% ----------------------------------------------------------------------
% plot_figureS1(sub)
% ----------------------------------------------------------------------
% Goal of the function :
% Draw Figure S1 as in manuscript
% ----------------------------------------------------------------------
% Input(s) :
...
% load data
load(sprintf('%s/%s_sac2AfterSac1LatT_norm.mat',sub.deriv_filedir,sub.ini));
...
nameFig = 'Figure 2: Inter-saccadic trials'; 
matRes = sac2AfterSac1LatT;
...
for tRow = 1:numRow
    ...
    for tCol = 1:numCol
        switch tCol
            case 1 % visual + early 1st saccade
                if tRow == 1;valStepX = 0.5/3;
                elseif tRow == 2;valStepX = 5/3;
                end
            ...
            case 2 % auditory + early 1st saccade
                if tRow == 1;valStepX = 0.25/3;
                elseif tRow == 2;valStepX = 2.5/3;
                end
                txtCol = 'Auditory';
                cond1 = 2;
                sac1Lat = 1;
                
            case 3 % audiovisual + early 1st saccade
                if tRow == 1;valStepX = 0.5/3;
                elseif tRow == 2;valStepX = 5/3;
                end
                txtCol = 'Audiovisual';
            ...
            case 4 % visual + late 1st saccade
                if tRow == 1;valStepX = 0.5/3;
                elseif tRow == 2;valStepX = 5/3;
                end
            ...
            case 5 % auditory + late 1st saccade
                if tRow == 1;valStepX = 0.25/3;
                elseif tRow == 2;valStepX = 2.5/3;
                end
                txtCol = 'Auditory';
            ...
            case 6 % audiovisual + late 1st saccade
                if tRow == 1;valStepX = 0.5/3;
                elseif tRow == 2;valStepX = 5/3;
                end
                txtCol = 'Audiovisual';
        ...
        if tRow == 1
            ...
            matPlot = matRes{cond1,rand1,sac1Lat}{2};
...
%             end
        ...
        elseif tRow ==2
            pos_bar = 2.25;
            valPlot = matRes{cond1,rand1,sac1Lat}{3};
            ...
            pos_indiv = 2.25;
            valPlotIndiv = matRes{cond1,rand1,sac1Lat}{7};
        ...
        % plot title
        if tRow == 1
            text(0,19,sprintf('1st sac.: %1.2f +/- %1.2f ms\n%s\ndistractor',matRes{cond1,rand1,sac1Lat}{4}(1),matRes{cond1,rand1,sac1Lat}{4}(2),txtCol),...
                'HorizontalAlignment','center','VerticalAlignment','middle');
        end

    end
end
saveas(f,sprintf('%s/FigureS1.pdf',sub.deriv_filedir));      % classical save
