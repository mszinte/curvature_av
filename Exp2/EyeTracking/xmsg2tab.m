        ...
        if ~isempty(line)                           % skip empty lines
            ...
            if length(la) >= 3
                switch char(la(3))
                    ...
                    case 'TRIAL_END';                       msgTab(t,3)  = str2double(char(la(2)));
                    ...
                    case 'DIST1_START';                     msgTab(t,16) = str2double(char(la(2)));
                    case 'DIST1_END';                       msgTab(t,17) = str2double(char(la(2)));
                    case 'DIST2_START';                     msgTab(t,18) = str2double(char(la(2)));
                    case 'DIST2_END';                       msgTab(t,19) = str2double(char(la(2)));

                    % End of trial
                    case 'RUN_TRIAL_END';                   msgTab(t,20) = str2double(char(la(2)));
                    case 'TRIAL_EYEOK';                     msgTab(t,21) = str2double(char(la(2)));
                    case 'TRIAL_EYENOTOK';                  msgTab(t,22) = str2double(char(la(2)));
                    case 'EVENT_GET_ANSWER';                msgTab(t,23) = str2double(char(la(2)));
